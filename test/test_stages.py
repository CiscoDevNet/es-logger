...
class TestStageEvent(object):
    ...
    def test_with_stage_report(self):
        ...
        esl.get_stages.return_value = {
            ...
            "endTimeMillis": 1549926650050, "durationMillis": 8623, "queueDurationMillis": 1, "pauseDurationMillis": 0,
            "stages": [
                {"_links": {"self": {"href": "/job/test/job/HelloWorld/78/execution/node/6/wfapi/describe"}},
                 "id": "6", "name": "Stage 1", "execNode": "", "status": "SUCCESS", "startTimeMillis": 1549926642588,
                 "durationMillis": 18,"pauseDurationMillis": 0},
                {"_links": {"self": {"href": "/job/test/job/HelloWorld/78/execution/node/11/wfapi/describe"}},
                 "id": "11", "name": "Stage 2", "execNode": "", "status": "SUCCESS", "startTimeMillis": 1549926642613,
                 "durationMillis": 17,"pauseDurationMillis": 0},
                {"_links": {"self": {"href": "/job/test/job/HelloWorld/78/execution/node/16/wfapi/describe"}},
                 "id": "16", "name": "Declarative: Post Actions", "execNode": "", "status": "SUCCESS",
                 "startTimeMillis": 1549926642637, "durationMillis": 7398, "pauseDurationMillis": 0}
            ]
        }
        events = eg.generate_events(esl)
        nose.tools.ok_(len(events) == 3, "Wrong number of events returned ({}): {}".format(len(events), events))
        results = [
            {"status": "SUCCESS", "id": "6", "pauseDurationMillis": 0, "durationMillis": 18,
             "_links": {"self": {"href": "/job/test/job/HelloWorld/78/execution/node/6/wfapi/describe"}},
             "startTimeMillis": 1549926642588, "execNode": "", "name": "Stage 1"},
            {"status": "SUCCESS", "id": "6", "pauseDurationMillis": 0, "durationMillis": 17,
             "_links": {"self": {"href": "/job/test/job/HelloWorld/78/execution/node/11/wfapi/describe"}},
